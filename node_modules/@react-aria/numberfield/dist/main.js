...
function $fa863e9b015ae839$export$23f548e970bdf099(props, state, inputRef) {
    let { id: id, decrementAriaLabel: decrementAriaLabel, incrementAriaLabel: incrementAriaLabel, isDisabled: isDisabled, isReadOnly: isReadOnly, isRequired: isRequired, minValue: minValue, maxValue: maxValue, autoFocus: autoFocus, validationState: validationState, isInvalid: isInvalid, label: label, formatOptions: formatOptions, onBlur: onBlur = ()=>{}, onFocus: onFocus, onFocusChange: onFocusChange, onKeyDown: onKeyDown, onKeyUp: onKeyUp, description: description, errorMessage: errorMessage, ...otherProps } = props;
    ...
    let { labelProps: labelProps, inputProps: textFieldProps, descriptionProps: descriptionProps, errorMessageProps: errorMessageProps } = (0, $2wEZH$reactariatextfield.useFormattedTextField)({
        ...
        onKeyDown: (0, $2wEZH$react.useMemo)(()=>(0, $2wEZH$reactariautils.chain)(onKeyDownEnter, onKeyDown), [
            onKeyDownEnter,
            onKeyDown
        ]),
        onKeyUp: onKeyUp,
    ...
    (0, $2wEZH$reactariautils.useFormReset)(inputRef, state.numberValue, state.setNumberValue);
